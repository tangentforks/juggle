NB.  Phrases from Chapter 8, Section A of J Phrases.

n0=: pi=: 1p1                   NB.
v1=: PI=: 1p1"_                 NB.Other ranks are possible
n2=: 2p1 1r2p1 1r6p1            NB.List of multiples of 
n3=: 2p_1 1r2p_1 1r6p_1         NB.Multiples of reciprocal 
n4=: 1x1                        NB.Euler’s number (2.71828 ...)
...
m13=: stirg =: sbase * scorr    NB.Stirling’s approx for (y) [AS[1]  6.1.37]
n14=: |1-(!10)%stirg 1+10       NB.Relative error for !10
m15=: stirf =: ^@(1r12&%)      *%:@(2p1&*) * %&1x1 ^ ]  NB.Stirling’s approx to !y [AS[1]  6.1.38]
...
m65=: = */ .^/@dpe              NB."
m66=: divisors=: /:~@(~. */ .^"1     odometer@:>:@(#/.~))@q:  NB.Divisors of y. Try m66 900
m67=: /:~@~.@(*/ .^"1 tt@#)@q:  NB."
m68=: /:~@,@>@(*/&.>/)@ (<@(1&,)     @(*/\)/.~) @ q:  NB."
m69=: >:@i. ([ #~ 0: = |) ]     NB."
