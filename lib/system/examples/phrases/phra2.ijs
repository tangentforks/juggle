NB.  Phrases from Chapter 2, Section A of J Phrases.

m0=: 1&+                        NB.Increment >:
m1=: +&1                        NB."
m2=: _1&+                       NB.Decrement <:
m3=: -&1                        NB."
m4=: 1&-                        NB.Not -. (logical and prob complement)
m5=: 1&~:                       NB. "
m6=: 0&=                        NB. "
...
a79=: each=: &.>                NB.Apply argument function to each box
a80=: inv=: ^:_1                NB.Inverse
a81=: ^:_                       NB.Limit
a82=: (D.1) " 0                 NB.First derivative
a83=: ;.1                       NB.Partition
a84=: !.0                       NB.Exact comparison; e.g. = a84
a85=: "0                        NB.Constant function on scalars
a86=: "1                        NB.Constant function on lists
a87=: "_1                       NB.Constant function on items
a88=: "_                        NB.Constant function on entire argument
a89=: 0!:                       NB.Script; silent execute is se=: 0 a89
a90=: file=: 1!:                NB.File; e.g. read=:1 file
