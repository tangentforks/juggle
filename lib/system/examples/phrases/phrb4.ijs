NB.  Phrases from Chapter 4, Section B of J Phrases.

m0=: \:                         NB.Downgrade
m1=: {.@\:                      NB.Index of (IO) first occurrence of max
m2=: i.>./                      NB.IO first occurrence of maximum of y
m3=: {:@/:                      NB.IO last occurrence of maximum of y
m4=: {.@/:                      NB.IO first occurrence of minimum of y
m5=: {:@\:                      NB.IO last occurrence of minimum of y
m6=: i.<./                      NB.IO first occurrence of minimum of y
d7=: ~: i. 1:                   NB.IO first item where x and y differ
m8=: # - 1: #.~ ] = ' '"_       NB.IO last nonblank in y
...
m23=: <:@(+/\) i. i.@(+/)       NB.ISO 1s in Boolean list y
...
m38=: <"1                       NB.(Bxed) indices from rows of open table y
m39=: $ #: (# i.@$)@,           NB.Open ISO 1s in array y  (inverse of m85)
